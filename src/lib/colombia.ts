/**
 * Municipios de Colombia por departamento (DANE, 32 departamentos + Bogotá D.C.).
 * 1103 municipios. Hay nombres que se repiten entre departamentos
 * (Armenia, Caldas, Granada, La Victoria…), por eso el selector siempre
 * muestra el departamento y la ciudad se guarda junto a él.
 *
...
export const DEPARTAMENTOS: Departamento[] = [
  ...
  {
    nombre: "Atlántico",
    municipios: ["Baranoa", "Barranquilla", "Campo de la Cruz", "Candelaria", "Galapa", "Juan de Acosta", "Luruaco", "Malambo", "Manatí", "Palmar de Varela", "Piojó", "Polonuevo", "Ponedera", "Puerto Colombia", "Repelón", "Sabanagrande", "Sabanalarga", "Santa Lucía", "Santo Tomás", "Soledad", "Suán", "Tubará", "Usiacurí"],
  },
  {
    nombre: "Bolívar",
  ...
  {
    nombre: "Sucre",
    municipios: ["Buenavista", "Caimito", "Chalán", "Colosó", "Corozal", "Coveñas", "El Roble", "Galeras", "Guaranda", "La Unión", "Los Palmitos", "Majagual", "Morroa", "Ovejas", "Sampués", "San Antonio de Palmito", "San Benito Abad", "San Juan de Betulia", "San Marcos", "San Onofre", "San Pedro", "Sincelejo", "Sincé", "Sucre", "Tolú", "Tolú Viejo"],
  },
  {
    nombre: "Tolima",
    municipios: ["Alpujarra", "Alvarado", "Ambalema", "Anzoátegui", "Armero", "Ataco", "Cajamarca", "Carmen de Apicalá", "Casabianca", "Chaparral", "Coello", "Coyaima", "Cunday", "Dolores", "El Espinal", "Falán", "Flandes", "Fresno", "Guamo", "Herveo", "Honda", "Ibagué", "Icononzo", "Lérida", "Líbano", "Mariquita", "Melgar", "Murillo", "Natagaima", "Ortega", "Palocabildo", "Piedras", "Planadas", "Prado", "Purificación", "Rioblanco", "Roncesvalles", "Rovira", "Saldaña", "San Antonio", "San Luis", "Santa Isabel", "Suárez", "Valle de San Juan", "Venadillo", "Villahermosa", "Villarrica"],
  },
  {
  ...
  {
    nombre: "Vaupés",
    municipios: ["Carurú", "Mitú", "Taraira"],
  },
  {
    nombre: "Vichada",
...
export const MUNICIPIOS: Municipio[] = DEPARTAMENTOS.flatMap((d) =>
  d.municipios.map((ciudad) => ({ ciudad, departamento: d.nombre })),
)

/** Quita tildes y pasa a minúsculas: buscar "tulua" encuentra "Tuluá". */
