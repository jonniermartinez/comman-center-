...
test.describe("Flujos por correo", () => {
  ...
  test(
    ...
    anotar({
      ...
      tipo: "feature",
      porque:
        "Si la invitación se rompe, nadie nuevo puede entrar al sistema, y no se nota hasta que alguien lo intenta.",
    }),
  ...
  test(
    ...
    anotar({
      ...
      tipo: "seguridad",
      porque:
        "Si la pantalla distingue entre correo con cuenta y sin ella, sirve para averiguar quién trabaja aquí.",
    }),
    async ({ page }) => {
