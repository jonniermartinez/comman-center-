...
test.describe("Captura diaria", () => {
  ...
  test(
    ...
    async ({ coordinador, apiSuperAdmin }) => {
      ...
      await rellenar(coordinador, { fecha: HOY, monto: "750000", recibo: "REC-001" })
  ...
  test(
    ...
    async ({ coordinador, apiSuperAdmin }) => {
      ...
      await rellenar(coordinador, { "ll-cont": "40", "ll-agen": "12", "at-venta": "3" })
      await guardar(coordinador)
  ...
  test(
    ...
    async ({ coordinador, apiSuperAdmin }) => {
      ...
      await rellenar(coordinador, { fecha: HOY, nombre: quien, monto: "250000" })
      await guardar(coordinador)
  ...
  test(
    ...
    async ({ coordinador, apiSuperAdmin }) => {
      ...
      await abrirDialogoDe(
        coordinador,
        coordinador
          .getByRole("button", { name: new RegExp(`Editar la venta de ${cliente}`) })
          .first(),
        /Editar venta/,
        `el lápiz de ${cliente}`,
      )
