...
test.describe("Sin sesión", () => {
  ...
  test(
    ...
    anotar({
      ...
      tipo: "seguridad",
      porque:
        "Lo mínimo exigible a un formulario de acceso.",
    }),
    async ({ page }) => {
    await irA(page, "/login")
...
test.describe("Super admin", () => {
  ...
  test(
    ...
    anotar({
      ...
      tipo: "feature",
      porque:
        "Ve todas las empresas y puede dar de alta clientes nuevos.",
    }),
    async ({ superAdmin }) => {
    await irA(superAdmin, "/empresas")
...
test.describe("Coordinador", () => {
  test(
    ...
    anotar({
      ...
      tipo: "seguridad",
      porque:
        "Un coordinador administra su empresa, no la plataforma.",
    }),
    async ({ coordinador }) => {
  ...
  test(
    ...
    anotar({
      ...
      tipo: "feature",
      porque:
        "Es lo que distingue a un coordinador de un asesor.",
    }),
    async ({ coordinador }) => {
...
test.describe("Asesor", () => {
  test(
    ...
    anotar({
      ...
      tipo: "seguridad",
      porque:
        "El asesor captura; no configura nada.",
    }),
    async ({ asesorA }) => {
  ...
  test(
    ...
    anotar({
      ...
      tipo: "seguridad",
      porque:
        "Ni por la dirección directa se llega a una empresa ajena.",
    }),
    async ({ asesorA }) => {
  ...
  test(
    ...
    anotar({
      ...
      tipo: "seguridad",
      porque:
        "Ahí está la lista de las cincuenta personas reales del sistema.",
    }),
    async ({ asesorA }) => {
